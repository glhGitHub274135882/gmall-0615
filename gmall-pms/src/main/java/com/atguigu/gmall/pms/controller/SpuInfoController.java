...
public class SpuInfoController {
    ...
    @GetMapping
    public Resp<PageVo> querySpuInfoByKeyPage(QueryCondition condition, @RequestParam(value = "catId",defaultValue = "0")Long catId){

        PageVo page = this.spuInfoService.querySpuInfoByKeyPage(condition, catId);
        return Resp.ok(page);
    }
    ...
    public Resp<List<SpuInfoEntity>> list(QueryCondition queryCondition) {
